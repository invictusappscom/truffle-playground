const contract = artifacts.require('Weth')

const contractWethAddress = '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'
...
module.exports = async (callback) => {
  const ins = await contract.at(contractWethAddress)
